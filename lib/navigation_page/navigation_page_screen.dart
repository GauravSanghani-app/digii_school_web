import 'package:digi_school/attendance_screen/attendance_screen.dart';
import 'package:digi_school/classroom_screen/classroom_screen.dart';
import 'package:digi_school/dashboard/navigation_page/navigation_screen.dart';
import 'package:digi_school/exam_screen/exam_record_screen.dart';
import 'package:digi_school/fees_screen/fee_screen.dart';
import 'package:digi_school/home_screen/home_screen.dart';
import 'package:digi_school/home_screen/notification_screen.dart';
import 'package:digi_school/message_screen/messages_screen.dart';
import 'package:digi_school/performance_screen/performance_Screen.dart';
import 'package:digi_school/phone_details_screen/phone_details_screen.dart';
import 'package:digi_school/profile_screen/profile_screen.dart';
import 'package:digi_school/transport_details/transport_screen.dart';
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>DashNavigationScreen()));
                        },
                        child: Container(
                          height: width * 0.2256,
