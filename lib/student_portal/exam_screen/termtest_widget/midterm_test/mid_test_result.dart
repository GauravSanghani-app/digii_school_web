...
class MidTestResultScreen extends StatefulWidget {
  @override
  _MidTestResultScreenState createState() => _MidTestResultScreenState();
}

class _MidTestResultScreenState extends State<MidTestResultScreen> {
